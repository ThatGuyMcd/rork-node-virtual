...
export default function SettingsScreen() {
  ...
  const renderDangerZoneContent = () => (
    <>
      <View style={[styles.card, { backgroundColor: colors.cardBackground, borderColor: colors.border }]}>
        <Text style={[styles.infoText, { color: colors.textSecondary }]}>WARNING! This will REMOVE all synced data, sales data, credentials, and reset the app to its initial state.</Text>
      </View>
      <TouchableOpacity
  ...
  {[
    ...
    '#f5f5f5','#e5e5e5','#d4d4d4','#a3a3a3','#737373','#525252','#404040','#262626','#171717','#0a0a0a', // neutral
    ...
    // -------------------------
    // Extra “off-menu” accents (a few loud ones)
    // -------------------------
    '#000000','#ffffff','#00c2ff','#00ffd1','#39ff14','#ffd700','#ff3d00','#ff00ff','#7fff00','#00ff7f',
  ].map((color) => (
                  <TouchableOpacity
                    key={color}
